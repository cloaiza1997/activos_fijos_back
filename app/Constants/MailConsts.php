...
class MailConsts
{
    ...
    const EMAIL_TEMPLATE_CERTIFICATE_ACTIVE = "EMAIL_TEMPLATE_CERTIFICATE_ACTIVE";
    const EMAIL_TEMPLATE_CERTIFICATE_APPROVED = "EMAIL_TEMPLATE_CERTIFICATE_APPROVED";
    const EMAIL_TEMPLATE_CERTIFICATE_SIGNATURE_PENDING = "EMAIL_TEMPLATE_CERTIFICATE_SIGNATURE_PENDING";
    const EMAIL_TEMPLATE_DERECOGNITIOIN_APPROVED = "EMAIL_TEMPLATE_DERECOGNITIOIN_APPROVED";
    ...
    const EMAIL_TEMPLATE_USER_PASSWORD = "EMAIL_TEMPLATE_USER_PASSWORD";
